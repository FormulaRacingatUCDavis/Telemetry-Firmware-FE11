 ...
 *      Author: leoja
 *
 *  Created this to dodge circular imports problem. Used to be in ugui.h
 *
 *
 */

#ifndef INC_UGUI_TYPES_H_
#define INC_UGUI_TYPES_H_
...
// new drivers by Leo Janzen
#define DRIVER_SET_WINDOW							  4
#define DRIVER_WRITE_DATA_START                       5
#define DRIVER_PUSH_PIXEL                             6
...
#define C_YELLOW                      0xffc0
#define C_ORANGE_RED                  0xfca0         
#define C_RED                         0xf800
